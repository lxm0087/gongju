	...
	searchItems: function() {
		...
		itemsObj1.add("0", [{
			src: "",
				...
				src: "/laimei/xiongbu/#t1",
				txt: '胸部'
			}, {
				src: "/laimei/mianbu/#t1",
				txt: '面部'
			}, {
				src: "/laimei/zhifang/#t1",
				txt: '脂肪'
			}, {
				src: "/laimei/weizhenx/#t1",
				txt: '微整形'
			}, {
				src: "/laimei/pifu/#t1",
				txt: '皮肤'
		...
		$(".item1 .btn-text").on("click",function(){
		...
		obj1.find("li").each(function(){
			...
			$(".keywordSelect .btn-text").on("click",function(){
		...
		$(".switch1 .bt").on("click", function() {
			if($(".item1 .btn-text").attr("value")!= ""){
						$(this).attr({
					"href": $(".item1 .btn-text").attr("data-src"),
					"target": "_blank"
				});
			}else{
					alert("选择您想要改变的部位!")
		...
		$(".keywordSelect .bt").on("click", function() {
			if($(".keywordSelect .btn-text").attr("value")!=""){
			$(this).attr({
				"href": $(".keywordSelect .btn-text").attr("data-src"),
				"target": "_blank"
			});}else{
					alert("选择您想要改变的部位!")
			}
